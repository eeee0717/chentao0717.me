...
## Chapter3
### 装饰器声明
`@Injectable`, `@DependsOn`, `@ServicePhase`
使用 `TypeScript` 的 `ClassDecorator` 和反射特性附加到类中。
```ts
...
![Cherry Studio lifecycle metadata runtime and collaboration structure](/images/cherry.lifecycle.6.png)
...
![Cherry Studio lifecycle SOP](/images/cherry.lifecycle.7.png)
