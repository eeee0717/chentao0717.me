...
<template>
  <div class="prose m-auto mb-8 select-none animate-none! op100!">
    ...
    <div mb-0 flex="~ col gap-1 sm:row sm:gap-3 wrap" text-3xl>
      ...
      <RouterLink to="/photos" class="!border-none" :class="route.path === '/photos' ? activeStyle : inactiveStyle">
        Photos
      </RouterLink>
      <RouterLink to="/notes" class="!border-none" :class="route.path === '/notes' ? activeStyle : inactiveStyle">
        Notes
      </RouterLink>
      <RouterLink to="/projects-detail" class="!border-none" :class="route.path === '/projects-detail' ? activeStyle : inactiveStyle">
        Projects
      </RouterLink>
    </div>
  </div>
